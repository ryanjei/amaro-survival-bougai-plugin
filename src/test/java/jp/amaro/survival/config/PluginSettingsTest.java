...
class PluginSettingsTest {
    @Test void readsSupportedValuesFromYamlConfiguration() {
        ...
        yaml.set("base-raid.ambient-spawn-interval-seconds", 9);
        yaml.set("base-raid.ambient-mobs-per-spawn", 3);
        ...
        assertEquals(Duration.ofSeconds(9), settings.ambientSpawnInterval());
        assertEquals(3, settings.ambientMobsPerSpawn());
    }
    ...
    @Test void rejectsUnsafeConfiguration() {
        assertThrows(IllegalArgumentException.class, () -> new PluginSettings(false, true, 0, Map.of(InterferenceCategory.SMALL, 1), Duration.ofSeconds(180), 40, Duration.ofSeconds(30), 8, Duration.ofSeconds(8), 2));
        assertThrows(IllegalArgumentException.class, () -> new PluginSettings(false, true, 10, Map.of(InterferenceCategory.SMALL, 0), Duration.ofSeconds(180), 40, Duration.ofSeconds(30), 8, Duration.ofSeconds(8), 2));
        assertThrows(IllegalArgumentException.class, () -> new PluginSettings(false, true, 10, Map.of(InterferenceCategory.SMALL, 1), Duration.ofSeconds(180), 40, Duration.ofSeconds(30), 41, Duration.ofSeconds(8), 2));
        assertThrows(IllegalArgumentException.class, () -> new PluginSettings(false, true, 10, Map.of(InterferenceCategory.SMALL, 1), Duration.ofSeconds(180), 40, Duration.ofSeconds(30), 8, Duration.ZERO, 2));
        assertThrows(IllegalArgumentException.class, () -> new PluginSettings(false, true, 10, Map.of(InterferenceCategory.SMALL, 1), Duration.ofSeconds(180), 40, Duration.ofSeconds(30), 8, Duration.ofSeconds(8), 0));
    }
}
